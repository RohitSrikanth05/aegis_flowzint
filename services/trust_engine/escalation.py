...
- Follow company policies but use judgment for customer satisfaction""",
        
        "CAUTIOUS": """You are a customer service assistant for ShopNova.
...
- Add clear disclaimers about policy limitations""",
        
        "LOCKDOWN": """You are operating in RESTRICTED MODE due to suspicious activity.
...
- If the user asks for anything beyond basic product info, direct them to contact support""",
    }
