...
export const Route = createFileRoute("/admin/learning-queue")({
  head: () => ({
    meta: [
      { title: "AEGIS Admin — Knowledge Learning Queue" },
      {
        name: "description",
        content: "Admin: review and approve AI-detected knowledge gaps.",
      },
    ],
  }),
  component: AdminLearningQueuePage,
});
...
function AdminLearningQueuePage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] font-sans text-white">
      ...
      <div className="pointer-events-none fixed inset-0">
        ...
        <div className="absolute bottom-0 left-1/2 h-[300px] w-[300px] rounded-full bg-violet-600/10 blur-[140px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 py-10">
        ...
        >
          <div className="flex items-center gap-4">
            ...
            {/* Admin badge */}
            <span className="flex items-center gap-1 rounded-full border border-amber-500/30 bg-amber-500/10 px-2.5 py-0.5 text-[9px] font-semibold uppercase tracking-wider text-amber-300">
